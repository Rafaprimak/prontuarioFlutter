//classe firestoreservice com metodos adicionarprontuario, deletarprontuario e getprontuarios
import 'package:cloud_firestore/cloud_firestore.dart';
import '../models/prontuario.dart';

class FirestoreService {
  final CollectionReference prontuariosCollection = FirebaseFirestore.instance.collection('prontuarios');
